...
`;
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[4](/*tune*/ ctx[9]);
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*tuning*/ 1 && t_value !== (t_value = /*tune*/ ctx[9] + "")) set_data(t, t_value);
    		},
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*currently_playing*/ 2) set_data(t1, /*currently_playing*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function playNote(tune) {
    		...
    		synth.triggerAttackRelease(getFrequenz(tune), 1.8, now$1);
