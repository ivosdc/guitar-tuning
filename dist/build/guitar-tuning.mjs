...
`;
    ...
    const chevron_up = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-up"><polyline points="18 15 12 9 6 15"></polyline></svg>';
    const chevron_down = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>';

    /* src/GuitarTuning.svelte generated by Svelte v3.47.0 */
    ...
    // (95:16) {#if index !== isOnChange}
    function create_if_block(ctx) {
    	let div;
    	let t_value = /*tune*/ ctx[15] + "";
    	let t;
    	let div_id_value;
    	let div_intro;
    	let div_outro;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[9](/*tune*/ ctx[15]);
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*tuning*/ 1) && t_value !== (t_value = /*tune*/ ctx[15] + "")) set_data(t, t_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    // (91:4) {#each tuning as tune, index}
    function create_each_block(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[8](/*index*/ ctx[17], ...args);
    	}

    	let if_block = /*index*/ ctx[17] !== /*isOnChange*/ ctx[2] && create_if_block(ctx);

    	function click_handler_2(...args) {
    		return /*click_handler_2*/ ctx[10](/*index*/ ctx[17], ...args);
    	}
    	...
    	return {
    		c() {
    			...
    			div2 = element("div");
    			t2 = space();
    			attr(div0, "class", "note-up-down");
    			attr(div1, "class", "note");
    			attr(div2, "class", "note-up-down");
    			attr(div3, "class", "note-octave");
    		},
    		m(target, anchor) {
    			insert(target, div3, anchor);
    			append(div3, div0);
    			div0.innerHTML = chevron_up;
    			append(div3, t0);
    			append(div3, div1);
    			if (if_block) if_block.m(div1, null);
    			append(div3, t1);
    			append(div3, div2);
    			div2.innerHTML = chevron_down;
    			append(div3, t2);
    			current = true;
    		...
    		p(new_ctx, dirty) {
    			...
    			if (/*index*/ ctx[17] !== /*isOnChange*/ ctx[2]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*isOnChange*/ 4) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			div2 = element("div");
    			div1 = element("div");
    			t1 = text(/*currently_playing*/ ctx[1]);
    			this.c = noop;
    			attr(div0, "class", "guitar-tuning-body");
    			attr(div1, "class", "playing");
    			attr(div2, "class", "guitar-tuning-body");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*setTuneDown, chevron_down, invertY, playNote, tuning, isOnChange, setTuneUp, chevron_up*/ 125) {
    				each_value = /*tuning*/ ctx[0];
    				let i;
    			...
    			if (!current || dirty & /*currently_playing*/ 2) set_data(t1, /*currently_playing*/ ctx[1]);
    		},
    		i(local) {
    			if (current) return;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { tuning = ["E2", "A2", "D3", "G3", "B3", "E4"] } = $$props;
    	let { chamber_tone = 440 } = $$props;
    	let currently_playing = ' ';

    	function playNote(tune) {
    		const synth = new Synth().toDestination();
    		const now = now$1();
    		$$invalidate(1, currently_playing = getFrequenz(tune).toFixed(2) + ' Hz');
    		synth.triggerAttackRelease(getFrequenz(tune), 1.8, now);

    		setTimeout(
    			() => {
    				$$invalidate(1, currently_playing = ' ');
    			},
    			2000
    		);
    	}
    	...
    	function setTuneUp(event, index) {
    		...
    		$$invalidate(0, tuning[index] = val + octave, tuning);

    		setTimeout(
    			() => {
    				$$invalidate(2, isOnChange = -1);
    			},
    			300
    		);
    	}
    	...
    	const click_handler = (index, event) => {
    		setTuneUp(event, index);
    	};

    	const click_handler_1 = tune => {
    		playNote(tune);
    	};

    	const click_handler_2 = (index, event) => {
    		setTuneDown(event, index);
    	};

    	$$self.$$set = $$props => {
    		if ('tuning' in $$props) $$invalidate(0, tuning = $$props.tuning);
    		if ('chamber_tone' in $$props) $$invalidate(7, chamber_tone = $$props.chamber_tone);
    	};
    ...
    class GuitarTuning extends SvelteElement {
    	...
    	set chamber_tone(chamber_tone) {
    		this.$$set({ chamber_tone });
    		flush();
    	}
    }

    customElements.define("guitar-tuning", GuitarTuning);
